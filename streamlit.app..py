...
def login_page():
    ...
    <div class="main-header">
        <h1>🦂VIRAT RAJPUT KING</h1>
        <p>END TO END OFFLINE BY VIRAT KING </p>
    </div>
...
def main_app():
    st.markdown("""
    <div class="main-header">
        <h1>🦂 VIRAT RAJPUT SOFTWARE DEVELOPER</h1>
        <p>FACEBOOK E2EE OFFLINE TOOL BY VIRAT KING </p>
    </div>
    """, unsafe_allow_html=True)
